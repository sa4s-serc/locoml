...
const ChangeEstimatorType = (props) => {
    ...
    useEffect(() => {
        const getClassifiersAndHyperparameters = async () => {
            ...
            const response = await axios.get(`${REACT_APP_MAIN_SERVER}getAllClassifiers`);
            setAllClassifiers(response.data);
            const response2 = await axios.get(`${REACT_APP_MAIN_SERVER}getClassifierMap`);
            ...
            const response3 = await axios.post(`${REACT_APP_MAIN_SERVER}getHyperparameters`, {
    ...
    const handleClassifierChange = (e) => {
        ...
        axios.post(`${REACT_APP_MAIN_SERVER}getHyperparameters`, {
